...
public class CircleView extends View {
    ...
    private void intiAttributes(Context context, AttributeSet attrs) {
        ...
        mPdDistance = a.getInteger(R.styleable.CircleView_arcDistance, mPdDistance);
        mArcBgColor = a.getColor(R.styleable.CircleView_arcBgColor, mArcBgColor);
        mArcForeStartColor = a.getColor(R.styleable.CircleView_arcForeStartColor, mArcForeStartColor);
        mArcForeEndColor = a.getColor(R.styleable.CircleView_arcForeEndColor, mArcForeEndColor);
        mDottedDefaultColor = a.getColor(R.styleable.CircleView_dottedDefaultColor, mDottedDefaultColor);
        mDottedRunColor = a.getColor(R.styleable.CircleView_dottedRunColor, mDottedRunColor);
        mDottedLineCount = a.getInteger(R.styleable.CircleView_dottedLineCount, mDottedLineCount);
        mDottedLineWidth = a.getInteger(R.styleable.CircleView_dottedLineWidth, mDottedLineWidth);
        mDottedLineHeight = a.getInteger(R.styleable.CircleView_dottedLineHeight, mDottedLineHeight);
        mLineDistance = a.getInteger(R.styleable.CircleView_lineDistance, mLineDistance);
        mProgressMax = a.getInteger(R.styleable.CircleView_progressMax, mProgressMax);
        mProgressTextSize = a.getInteger(R.styleable.CircleView_progressTextSize, mProgressTextSize);
        mProgressDesc = a.getString(R.styleable.CircleView_progressDesc);
        mProgressTextRunColor = a.getColor(R.styleable.CircleView_progressTextRunColor, mProgressTextRunColor);
        useGradient = a.getBoolean(R.styleable.CircleView_arcUseGradient, useGradient);
        a.recycle();
    }
