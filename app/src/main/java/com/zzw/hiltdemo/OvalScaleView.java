...
public class OvalScaleView extends View {
    ...
    private int rightArcLine4Alpha = 255;
    ...
    public OvalScaleView(Context paramContext) {
        this(paramContext, null);
    }

    public OvalScaleView(Context paramContext, AttributeSet paramAttributeSet) {
    ...
    private int sp2Px(float paramFloat) {
        return (int) ((mContext.getResources().getDisplayMetrics()).scaledDensity * paramFloat + 0.5F);
    }
    ...
    private void initPaint() {
        ...
        textPaint.setTextSize(sp2Px(10f));
    ...
    public boolean onTouchEvent(MotionEvent paramMotionEvent) {
        ...
        switch (paramMotionEvent.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                isDownEvent = false;
                if (Math.abs(moveTotalDy) < (ViewConfiguration.get(getContext()).getScaledTouchSlop() / 4)) {
                    upStartAnimator();
                    return true;
                }
